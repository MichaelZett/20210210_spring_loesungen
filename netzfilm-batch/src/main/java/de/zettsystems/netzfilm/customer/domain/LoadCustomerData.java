...
public class LoadCustomerData {
    ...
    public void createCustomer() {
        customerRepository.save(new Customer("Petra", "Meyer", LocalDate.of(1963, 7, 11), "user1"));
        customerRepository.save(new Customer("Frank", "Schuhmacher", LocalDate.of(1976, 4, 3), "user2"));
        final Customer customer = new Customer("Wiebke", "Müller", LocalDate.now(), "user3");
